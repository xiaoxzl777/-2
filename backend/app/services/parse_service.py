...
def parse_resume(resume_id: int, session_factory: SessionFactory) -> None:
    ...
    with session_factory() as db:
        ...
        try:
            ...
            _save_result(db, resume, layout, sections, extracted.page_count, extracted.ats_signals)
...
def _save_result(db: Session, resume: Resume, layout: LayoutResult, sections: list[Section],
                 page_count: int, ats_signals: dict) -> None:
